...
import { getLandingPage, landingPagesForBase } from "@/lib/seo-landing-pages";
import { hubOpenGraph } from "@/lib/seo";
import type { Metadata } from "next";
import { notFound } from "next/navigation";

const BASE = "/find-verified-online-tutors";
...
export default async function FindVerifiedOnlineTutorsPage({
  params,
}: {
  params: Promise<{ geo?: string | string[] }>;
}) {
